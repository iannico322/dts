...
const Footer = () => {
  return (
    <footer className=" animate__animated animate__fadeIn fixed bottom-0 h-12 sm:h-14 flex flex-row items-center justify-between sm:items-center md:flex-col md:items-center md:justify-center px-10 sm:px-0 sm:pl-0  bg-blue3 w-full text-white ">
