const Footer = () => {
  return (
    <footer className=" animate__animated animate__fadeIn fixed bottom-0 h-14 sm:h-14 flex flex-col items-start justify-center sm:items-center sm:pl-0 pl-10 bg-yellow w-full text-black ">
